...
class StatsLogger(object):
    ...
    def print_progress(self, epoch, batch, loss, precision="{:.5f}", show=True):
...
class WandB(StatsLogger):
    ...
    def print_progress(self, epoch, batch, loss,show, precision="{:.5f}"):
        super().print_progress(epoch, batch, loss, precision, show)
